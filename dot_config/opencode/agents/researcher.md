...
Record all findings in `.agents/docs/{concise-title}/research.md` within the project directory. The title should describe _what_ was researched (e.g., `auth-middleware-flow`, `payment-processing-architecture`).
