...
- Record your research findings in `.codex/user/research/{title}.md` files within each project directory. Choose a concise title that summarizes the research content.
